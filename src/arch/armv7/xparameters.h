...
/* Definitions for peripheral AXI_EXT_SLAVE_CONN_0 */
#define XPAR_AXI_EXT_SLAVE_CONN_0_S_AXI_MEM_RNG00_BASEADDR 0x41280000
#define XPAR_AXI_EXT_SLAVE_CONN_0_S_AXI_MEM_RNG00_HIGHADDR 0x4128FFFF
