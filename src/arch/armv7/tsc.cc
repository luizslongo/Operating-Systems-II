// EPOS-- ARMV7_TSC Implementation

#include <arch/armv7/tsc.h>

#include <machine.h>

__BEGIN_SYS

volatile ARMV7_TSC::Time_Stamp ARMV7_TSC::_ts = 0;

ARMV7_TSC::Time_Stamp ARMV7_TSC::time_stamp() {
    return cntr() | (_ts << 16);
}

void ARMV7_TSC::tsc_timer_handler() {
    _ts++;
}
