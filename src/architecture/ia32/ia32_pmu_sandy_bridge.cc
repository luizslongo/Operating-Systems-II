...
const Intel_Sandy_Bridge_PMU::Event Intel_Sandy_Bridge_PMU::_events[EVENTS] = {
    UNHALTED_REFERENCE_CYCLES,          // 0 : CPU_CYCLES,
    UNHALTED_CORE_CYCLES,               // 1 : UNHALTED_CYCLES,
 
    INSTRUCTIONS_RETIRED,               // 2 : INSTRUCTIONS_RETIRED,
    MEM_UOP_RETIRED_LOADS,              // 3 : LOAD_INSTRUCTIONS_RETIRED,
    MEM_UOP_RETIRED_STORES,             // 4 : STORE_INSTRUCTIONS_RETIRED,
    UNSUPORTED_EVENT,                   // 5 : INTEGER_ARITHMETIC_INSTRUCTIONS_RETIRED,
    UNSUPORTED_EVENT,                   // 6 : INTEGER_MULTIPLICATION_INSTRUCTIONS_RETIRED,
    UNSUPORTED_EVENT,                   // 7 : INTEGER_DIVISION_INSTRUCTIONS_RETIRED,
    UNSUPORTED_EVENT,                   // 8 : FPU_INSTRUCTIONS_RETIRED,
    UNSUPORTED_EVENT,                   // 9 : SIMD_INSTRUCTIONS_RETIRED,
    UNSUPORTED_EVENT,                   // 10: ATOMIC_MEMEMORY_INSTRUCTIONS_RETIRED,

    BRANCH_INSTRUCTIONS_RETIRED,        // 11: BRANCHES,
    BR_INST_EXEC_COND,                  // 12: CONDITIONAL_BRANCHES,         // for some architectures BRANCHES = IMIDIATE + CONDITIONAL
    UNSUPORTED_EVENT,                   // 13: PREDICTABLE_BRANCHES,
    UNSUPORTED_EVENT,                   // 14: IMIDIATE_BRANCHES,
    BRANCH_MISSES_RETIRED,              // 15: BRANCH_MISPREDICTIONS,
    UNSUPORTED_EVENT,                   // 16: BRANCH_DIRECTION_MISPREDICTIONS,
    BR_MISP_RETIRED_CONDITIONAL,        // 17: CONDITIONAL_BRANCH_MISPREDICTIONS,

    UNSUPORTED_EVENT,                   // 18: EXCEPTIONS,
    UNSUPORTED_EVENT,                   // 19: INTERRUPTS,

    MEM_LOAD_UOPS_RETIRED_L1_HIT,       // 20: L1_CACHE_HITS,
    MEM_LOAD_UOPS_RETIRED_L1_MISS,      // 21: L1_CACHE_MISSES,
    UNSUPORTED_EVENT,                   // 22: L1_DATA_CACHE_MISSES,
    L2_TRANS_L1D_WB,                    // 23: L1_DATA_CACHE_WRITEBACKS,
    ICACHE_MISSES,                      // 24: L1_INSTRUCTION_CACHE_MISSES,
    MEM_LOAD_UOPS_RETIRED_L2_HIT,       // 25: L2_CACHE_HITS,
    UNSUPORTED_EVENT,                   // 26: L2_CACHE_MISSES,
    UNSUPORTED_EVENT,                   // 27: L2_DATA_CACHE_MISSES,
    L2_TRANS_L2_WB,                     // 28: L2_DATA_CACHE_WRITEBACKS,
    LLC_REFERENCES,                     // 29: L3_CACHE_HITS,
    LLC_MISSES,                         // 30: L3_CACHE_MISSES,

    UNSUPORTED_EVENT,                   // 31: UNCACHED_MEMORY_ACCESSES,
    UNSUPORTED_EVENT,                   // 32: UNALIGNED_MEMORY_ACCESSES,
