...
int main()
{
    ...
    cout << "This is an int:\t\t\t" << (1 << sizeof(int) * 8 - 2) << "\n"
         << "\t\t\t\t" << hex << (1 << sizeof(int) * 8 - 2) << "(hex)\n"
         << "\t\t\t\t" << dec << (1 << sizeof(int) * 8 - 2) << "(dec)\n"
         << "\t\t\t\t" << oct << (1 << sizeof(int) * 8 - 2) << "(oct)\n"
         << "\t\t\t\t" << bin << (1 << sizeof(int) * 8 - 2) << "(bin) "
         << endl;
    cout << "This is a negative int:\t\t" << (1 << sizeof(int) * 8 - 1) << "\n"
