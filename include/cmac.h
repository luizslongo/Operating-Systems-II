...
public:
    ...
    static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
        db<CMAC<T> >(TRC) << "CMAC_States::Empty - UNPACK_FAILED\n";
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            if (CMAC<T>::_rx_pending) {
                db<CMAC<T> >(TRC) << "CMAC_States::Sync_Empty - RX_PENDING\n";
                return CMAC<T>::RX_PENDING;

            } else if (CMAC<T>::_tx_pending) {
                db<CMAC<T> >(TRC) << "CMAC_States::Sync_Empty - TX_PENDING\n";
                return CMAC<T>::TX_PENDING;

            } else {
                db<CMAC<T> >(TRC) << "CMAC_States::Sync_Empty - SYNC_END\n";
...
class Pack_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Pack_Empty - PACK_OK\n";
...
class Contention_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Contention_Empty - CHANNEL_IDLE\n";
...
class Tx_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Tx_Empty - TX_END\n";
...
class Ack_Rx_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Ack_Rx_Empty - TX_OK\n";
...
class Lpl_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Lpl_Empty - PREAMBLE_DETECTED\n";
...
class Rx_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Rx_Empty - RX_END\n";
...
class Unpack_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Unpack_Empty - UNPACK_OK\n";
...
class Ack_Tx_Empty: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Ack_Tx_Empty - RX_OK\n";
            return CMAC<T>::RX_OK;
        }
};
 ...
 */
template<typename T>
class Generic_Sync: public CMAC_State<T> {
    public:
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Generic_Sync - Setting timeout\n";

            CMAC<T>::timeout = false;
            CMAC<T>::alarm_activate(&alarm_handler, Traits<CMAC<T> >::TIMEOUT);

            if (CMAC<T>::_rx_pending) {
                db<CMAC<T> >(TRC) << "CMAC_States::Generic_Sync - RX_PENDING\n";
                return CMAC<T>::RX_PENDING;

            } else if (CMAC<T>::_tx_pending) {
                db<CMAC<T> >(TRC) << "CMAC_States::Generic_Sync - TX_PENDING\n";
                return CMAC<T>::TX_PENDING;

            } else {
                db<CMAC<T> >(TRC) << "CMAC_States::Generic_Sync - SYNC_END\n";
                return CMAC<T>::SYNC_END;
            }
        }
    ...
    private:
        static void alarm_handler() {
            db<CMAC<T> >(INF) << "CMAC_States::Generic_Sync - timeout\n";
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            ...
            for (int var = 0; var < 5; ++var) {
                db<CMAC<T> >(TRC) << "CMAC_States::Generic_Tx - sending\n";
                result = CMAC<T>::_radio->send(CMAC<T>::_frame_buffer, CMAC<T>::_frame_buffer_size);

                if (result == 0) {
                    db<CMAC<T> >(WRN) << "CMAC_States::Generic_Tx - Tx failed - Trying again\n";
                    CMAC<T>::_radio->off();
            ...
            if (result) {
                db<CMAC<T> >(TRC) << "CMAC_States::Generic_Tx - TX_END\n";
                return CMAC<T>::TX_END;

            } else {
                db<CMAC<T> >(ERR) << "CMAC_States::Generic_Tx - TX_ERROR\n";
...
class Generic_Rx: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            ...
            db<CMAC<T> >(TRC) << "CMAC_States::Generic_Rx - receiving\n";
            result = CMAC<T>::_radio->receive(&(CMAC<T>::_frame_buffer[0]));

            if (!(result > 0)) {
                db<CMAC<T> >(ERR) << "CMAC_States::Generic_Rx - RX_ERROR\n";
                CMAC<T>::_radio->off();
            ...
            db<CMAC<T> >(TRC) << "CMAC_States::Generic_Rx - RX_END\n";
            return CMAC<T>::RX_END;
        }
};
...
class Generic_Lpl: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        ...
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input, unsigned long soft_timeout) {
            db<CMAC<T> >(TRC) << "CMAC_States::Generic_Lpl - Listening\n";
            ...
            db<CMAC<T> >(INF) << "CMAC_States::Generic_Lpl::event_handler - FRAME_RECEIVED 2 \n";

            CMAC_STATE_TRANSITION transition;
            if (timeout) {
                db<CMAC<T> >(WRN) << "CMAC_States::Generic_Lpl - TIMEOUT\n";
                CMAC<T>::_radio->off();
                transition = CMAC<T>::TIMEOUT;
            } else {
                db<CMAC<T> >(INF) << "CMAC_States::Generic_Lpl - PREAMBLE_DETECTED\n";
                transition = CMAC<T>::PREAMBLE_DETECTED;
            }
    ...
    private:
        ...
        static void _event_handler(typename T::Event event) {
            ...
            if (event == T::SFD_DETECTED) {
                ...
                db<CMAC<T> >(INF) << "CMAC_States::Generic_Lpl::event_handler - FRAME_RECEIVED" << _frame_received << "\n";
            }
        }
...
template<typename T>
class Unslotted_CSMA_Contention: public CMAC_State<T> {
    public:
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::Unslotted_CSMA_Contention - Checking channel\n";
            ...
            while (nb < MAX_BACKOFFS) {
                ...
                db<CMAC<T> >(INF) << "CMAC_States::Unslotted_CSMA_Contention - Delay = " << delay << "\n";
                ...
                if (aux) {
                    db<CMAC<T> >(TRC) << "CMAC_States::Unslotted_CSMA_Contention - CHANNEL_IDLE\n";
                    return CMAC<T>::CHANNEL_IDLE;
                }
            ...
            db<CMAC<T> >(WRN) << "CMAC_States::Unslotted_CSMA_Contention - CHANNEL_BUSY\n";
...
public:
    ...
    static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - Setting timeout\n";
        ...
        if (Traits<CMAC<T> >::COORDINATOR) {
            ...
            set_time_out();
            set_sleeping_period();
            db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Beacon_Sync - Synchronized with coordinator\n";
        }

        if (CMAC<T>::_rx_pending) {
            db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - RX_PENDING\n";
            return CMAC<T>::RX_PENDING;

        } else if (CMAC<T>::_tx_pending) {
            db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - TX_PENDING\n";
            return CMAC<T>::TX_PENDING;

        } else {
            db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - SYNC_END\n";
            return CMAC<T>::SYNC_END;
        }
    }
...
private:
    static CMAC_STATE_TRANSITION pack_beacon(CMAC_STATE_TRANSITION previous) {
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - Creating frame\n";
        ...
        db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Beacon_Sync - Frame created:\n"
            << *beacon_frame_ptr;

        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - PACK_OK\n";
        return CMAC<T>::PACK_OK;
    }
    ...
    static CMAC_STATE_TRANSITION send_beacon() {
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - TX_END\n";
        return result;
    }

    static CMAC_STATE_TRANSITION unpack_beacon(CMAC_STATE_TRANSITION previous) {
        if (CMAC<T>::_frame_buffer_size == 0) {
            db<CMAC<T> >(ERR) << "CMAC_States::IEEE802154_Beacon_Sync - UNPACK_FAILED - Frame size == 0\n";
            return CMAC<T>::UNPACK_FAILED;
        }

        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - Decoding frame\n";

        beacon_frame_t *beacon_frame_ptr =
            reinterpret_cast<beacon_frame_t*>(CMAC<T>::_frame_buffer);

        db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Beacon_Sync - Frame decoded:\n"
            << *beacon_frame_ptr;
        ...
        if (beacon_frame_ptr->frame_check_sequence != crc) {
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Beacon_Sync - CRC error: " << crc << "\n";
            return CMAC<T>::UNPACK_FAILED;
        }

        if (beacon_frame_ptr->frame_control.frameType != IEEE802154_Frame<T>::FRAME_TYPE_BEACON) {
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Beacon_Sync - UNPACK_FAILED - Incorrect frame type\n";
            return CMAC<T>::UNPACK_FAILED;
        }
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - UNPACK_OK\n";
        return CMAC<T>::UNPACK_OK;
    }
    ...
    static CMAC_STATE_TRANSITION receive_beacon() {
        ...
        while (result != CMAC<T>::UNPACK_OK) {
            ...
            if (result == CMAC<T>::TIMEOUT) {
                db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Beacon_Sync - TIMEOUT\n";
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Beacon_Sync - RX_END\n";
        return CMAC<T>::RX_END;
    }

    static void alarm_handler() {
        db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Beacon_Sync - timeout\n";
        while (!CMAC<T>::timeout) CMAC<T>::timeout = true; // no excuses now
...
public:
    ...
    static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Pack - Creating frame\n";
        ...
        *crc_ptr = CRC::crc16(reinterpret_cast<char*>(CMAC<T>::_frame_buffer), CMAC<T>::_frame_buffer_size - 2);
        ...
        db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Pack - Frame created:\n"
            << *header_ptr
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Pack - PACK_OK\n";
...
public:
    ...
    static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
        if (CMAC<T>::_frame_buffer_size == 0) {
            db<CMAC<T> >(ERR) << "CMAC_States::IEEE802154_Unpack - UNPACK_FAILED - Frame size == 0\n";
            return CMAC<T>::UNPACK_FAILED;
        }

        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Unpack - Decoding frame\n";
        ...
        db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Unpack - Frame decoded:\n"
            << *header_ptr
            << "payload_size: " << CMAC<T>::_rx_data_size << "\n"
            << "CRC: " << *crc_ptr << "\n";
        ...
        if (*crc_ptr != crc) {
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Unpack - CRC error: " << crc << "\n";
            CMAC<T>::_stats->dropped_packets += 1;
            return CMAC<T>::UNPACK_FAILED;
        }

        if (header_ptr->frame_control.frameType != IEEE802154_Frame<T>::FRAME_TYPE_DATA) {
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Unpack - UNPACK_FAILED - Incorrect frame type\n";
            return CMAC<T>::UNPACK_FAILED;
        }
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Unpack - UNPACK_OK\n";
...
public:
    ...
    static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
        ...
        while (result != CMAC<T>::UNPACK_OK) {
            ...
            if (result == CMAC<T>::TIMEOUT) {
                if (CMAC<T>::_transmission_count < MAX_TRANSMISSION_COUNT) {
                    if (CMAC<T>::timeout) {
                        db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Ack_Rx - TIMEOUT\n";
                        return CMAC<T>::TIMEOUT;

                    } else {
                        db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Ack_Rx - Retransmitting\n";
                    ...
                    db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Ack_Rx - TX_FAILED\n";
                    CMAC<T>::_transmission_count = 0;
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Ack_Rx - TX_OK\n";
        CMAC<T>::_transmission_count = 0;
        return CMAC<T>::TX_OK;
    }
...
private:
    ...
    static CMAC_STATE_TRANSITION unpack_ack(CMAC_STATE_TRANSITION input) {
        ...
        if (CMAC<T>::_frame_buffer_size == 0) {
            db<CMAC<T> >(ERR) << "CMAC_States::IEEE802154_Ack_Rx - UNPACK_FAILED - Frame size == 0\n";
            return CMAC<T>::UNPACK_FAILED;
        }

        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Ack_Rx - Decoding frame\n";

        ack_frame_t *ack_frame_ptr =
            reinterpret_cast<ack_frame_t*>(CMAC<T>::_frame_buffer);

        db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Ack_Rx - Frame decoded:\n"
            << *ack_frame_ptr;

        unsigned short crc = CRC::crc16(reinterpret_cast<char*>(CMAC<T>::_frame_buffer), CMAC<T>::_frame_buffer_size - 2);

        if (ack_frame_ptr->frame_check_sequence != crc) {
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Ack_Rx - CRC error: " << crc << "\n";
            return CMAC<T>::UNPACK_FAILED;
        }

        if (ack_frame_ptr->frame_control.frameType != IEEE802154_Frame<T>::FRAME_TYPE_ACK) {
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Ack_Rx - UNPACK_FAILED - Incorrect frame type\n";
            return CMAC<T>::UNPACK_FAILED;
        }

        if (ack_frame_ptr->data_sequence_n != CMAC<T>::_data_sequence_number) {
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Ack_Rx - UNPACK_FAILED - Incorrect data sequence number\n";
            return CMAC<T>::UNPACK_FAILED;
        }

        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Ack_Rx - UNPACK_OK\n";
        return CMAC<T>::UNPACK_OK;
    }
};
...
public:
    ...
    static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
        ...
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Ack_Tx - RX_OK\n";
        return CMAC<T>::RX_OK;
    }
...
private:
    ...
    static CMAC_STATE_TRANSITION pack_ack(CMAC_STATE_TRANSITION input) {
        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Ack_Tx - Creating frame\n";
        ...
        db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Ack_Tx - Frame created:\n"
            << *ack_frame_ptr;

        db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Ack_Tx - PACK_OK\n";
        return CMAC<T>::PACK_OK;
    }
};
...
class IEEE802154_Slotted_CSMA_Contention: public CMAC_State<T> {
    ...
    typedef typename CMAC<T>::CMAC_STATE_TRANSITION CMAC_STATE_TRANSITION;
        static CMAC_STATE_TRANSITION execute(CMAC_STATE_TRANSITION input) {
            db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Slotted_CSMA_Contention - Checking channel\n";
            ...
            while (nb < MAX_BACKOFFS) {
                ...
                db<CMAC<T> >(INF) << "CMAC_States::IEEE802154_Slotted_CSMA_Contention - Delay = " << delay << "\n";
                ...
                bool aux = CMAC<T>::_radio->cca();
                if (aux) {
                    db<CMAC<T> >(TRC) << "CMAC_States::IEEE802154_Slotted_CSMA_Contention - CHANNEL_IDLE\n";
                    return CMAC<T>::CHANNEL_IDLE;
                }
                nb = nb + 1;
                be = be + 1;
            ...
            db<CMAC<T> >(WRN) << "CMAC_States::IEEE802154_Slotted_CSMA_Contention - CHANNEL_BUSY\n";
            return CMAC<T>::CHANNEL_BUSY;
        }
