...
template<> struct Traits<Scheduling_Criteria::PEDF>: public Traits_Tokens // Energy Optimizer
{
...
template<> struct Traits<Scheduling_Criteria::Priority>: public Traits_Tokens // Normal Application
{
