...
class ATMega16_ADC: public ADC_Common
{
 private:
 ...
 public:
    ...
    ATMega16_ADC()    { /* Default Initialization is up to init */ }

    ATMega16_ADC(Channel c,Reference r, Trigger t, Hertz f) {
	channel(c);
	reference(r);
	trigger(t);
	frequency(f);
