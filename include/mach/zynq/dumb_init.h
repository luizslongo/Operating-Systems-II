#ifndef __DUMB_INIT__
#define __DUMB_INIT__
class dumb_init{
	public:
void mask_write(unsigned long base, unsigned long mask, unsigned long value){
	*((unsigned long*)base) = mask & value;
}
unsigned long mask_poll(unsigned long base, unsigned long mask){
	return (*((unsigned long*)base)) & mask;
}
void ps7_pll_init_data_1_0 () {
...
void ps7_peripherals_init_data_1_0 () {
    mask_write(0XF8000008,0x0000FFFF,0x0000DF0D);
...
void ps7_peripherals_init_data_2_0 () {
    mask_write(0XF8000008,0x0000FFFF,0x0000DF0D);
    mask_write(0XF8000B48,0x00000180,0x00000180);
    mask_write(0XF8000B4C,0x00000180,0x00000180);
    mask_write(0XF8000B50,0x00000180,0x00000180);
...
void ps7_peripherals_init_data_3_0 () {
    mask_write(0XF8000008,0x0000FFFF,0x0000DF0D);
    mask_write(0XF8000B48,0x00000180,0x00000180);
    mask_write(0XF8000B4C,0x00000180,0x00000180);
    mask_write(0XF8000B50,0x00000180,0x00000180);
