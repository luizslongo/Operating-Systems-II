...
class Mica2_ADC: public ADC_Common
{
 private:
    ...
    typedef Traits<Mica2_ADC> _Traits;
 ...
 public:
    ...
    Mica2_ADC()    { /* Default Initialization is up to init */ }

    Mica2_ADC(Channel c,Reference r, Trigger t, Hertz f) {
	channel(c);
	reference(r);
	trigger(t);
	frequency(f);
