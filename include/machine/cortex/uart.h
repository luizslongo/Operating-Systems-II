...
class Zynq_UART: protected Cortex_Model
{
private:
...
class PL011: protected Cortex_Model
{
private:
...
class Cortex_UART: private UART_Common, private IF<Traits<Build>::MODEL == Traits<Build>::Zynq, Zynq_UART, PL011>::Result
{
private:
