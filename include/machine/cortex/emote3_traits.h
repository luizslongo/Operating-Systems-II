...
template <> struct Traits<Cortex_USB>: public Traits<Cortex_Common>
{
...
template <> struct Traits<Cortex_IEEE802_15_4>: public Traits<Cortex_Common>
{
...
template <> struct Traits<CC2538>: public Traits<Cortex_IEEE802_15_4>
{
