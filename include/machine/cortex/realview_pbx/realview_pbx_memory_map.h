...
struct Memory_Map: public Cortex_Memory_Map
{
    enum {
        ...
        BOOT_STACK              = FLAT_PAGE_TABLE - (Traits<Machine>::STACK_SIZE * Traits<Build>::CPUS), // will be used as the stack's base, not the stack pointer; SIZE = Traits<Build>::CPUS * Traits<Machine>::STACK_SIZE
