...
const Milisecond period_c = 80;
const Milisecond period_e = 167;
const Milisecond period_g = 90;
...
{   //                                       p,               d, c,             act, t
    ...
    */
    ...
    Periodic_Thread* b = new Periodic_Thread(RTConf(period_c * 1000, period_c * 1000, wcet_c * 1000, 0, iterations, EDF_Modified::BEST_EFFORT), &my_func, 'C', (int)1e7);
    ...
    Periodic_Thread* d = new Periodic_Thread(RTConf(period_g * 1000, period_g * 1000, wcet_g * 1000, 0, iterations, EDF_Modified::BEST_EFFORT)   , &my_func, 'G', (int)1e7);    
