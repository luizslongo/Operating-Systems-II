...
const unsigned int THREADS             = 3;//12;//8;//11;
...
int freq_control() {
    ...
    int iters = (TEST_LENGTH*1000000)/400000;
    for (int i = 0; i < iters; ++i)
    {
        cout << "Iter" << i << " - Keep Alive" << endl;//" - Clock = " << Machine::clock(1200000000 - (i % 7)*100000000) << endl;
        Delay(400000);
    }
    return iters;
}
